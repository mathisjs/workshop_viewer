...
(function(){
    ...
    function initSizes(){
        ...
        cols[0].style.flexBasis='25%';
        cols[1].style.flexBasis='25%';
        cols[2].style.flexBasis='50%';
    }
